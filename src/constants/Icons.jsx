...
export const BackIcon = ({ type }) => {
  return (
    <>
      {
        type === "profile" ?
          <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14.666 16.5V14.7692C14.666 13.1018 14.666 12.2681 14.5449 11.5705C13.8783 7.7304 10.5772 4.7187 6.36822 4.11049C5.60359 4 3.99366 4 2.16602 4" stroke="#012220" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M3.83301 6.5L2.04011 4.70711C1.70678 4.37377 1.54011 4.20711 1.54011 4C1.54011 3.79289 1.70678 3.62623 2.04011 3.29289L3.83301 1.5" stroke="#012220" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          :
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
...
export const Basket = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-[red]" xmlns="http://www.w3.org/2000/svg">
