    ...
    return (
        <div className=" flex relative w-full">
            <div className="container w-full flex justify-center align-center items-center ">
                <input type="text"
                    className="bg-tertiary py-2 px-2 w-[50%] placeholder:text-secondary bg-white text-black SearchIN outline-none border-none font-medium"
                    placeholder="Search Product..." value={query}
                    onChange={handleSearch} />
                <span className='bg-p5 text-p4 py-2 px-5 SearchB'><SearchIcon /> </span>
            </div>
            {showPopup && (
