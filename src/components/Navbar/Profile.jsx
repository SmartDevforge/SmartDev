    ...
    return (
        <>
            <div className="absolute z-[60] hidden sm:block  w-full">
                <div
                    className={`fixed  w-full bg-black bg-opacity-90 transform ${openProfile ? "translate-x-0" : "-translate-x-full"
                            ...
                            <div className=" overflow-y-auto h-[80vh]">
                                <div className="flex flex-col justify-between ">
                                    ...
                                    <div className="absolute z-[60] block w-full">
                                        <div
                                            className={`fixed right-0 top-0 w-full bg-black      bg-opacity-90 transition-transform duration-300 ease-in-out ${openProfile ? "translate-x-0" : "translate-x-full"
                                                }`}
                                        >
                    ...
                    <div className="bg-white absolute text-black w-full bottom-0 px-4 h-[70vh] rounded-t-[10%]">
                        <div className="flex w-full items-center p-2  justify-between">
                            <div className="flex justify-between items-center font-bold text-xl px-4 py-2 border-b">
                                ...
                                <div
                                    onClick={openProfile}
                                    className=" cursor-pointer border-[1px] p-1 rounded-xl"
                                >
                                    <BackIcon />
                                </div>
                            </div>
