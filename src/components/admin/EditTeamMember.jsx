...
import { ArrowLeft, Upload, X, User, Mail, Phone, MapPin, Calendar, Briefcase, Save } from "lucide-react"
...
const mockTeamMember = {
  ...
  firstName: "John",
  lastName: "Smith",
  email: "john.smith@smartdevforge.com",
  ...
  bio: "Experienced project manager with 8+ years in software development. Specializes in agile methodologies and team leadership.",
  skills: ["Project Management", "Agile/Scrum", "Team Leadership", "Risk Management"],
  experience: "8",
  education: "Master's in Business Administration",
  certifications: "PMP, Certified Scrum Master, PRINCE2",
  socialLinks: {
...
const EditTeamMember = () => {
  ...
  // Load team member data on component mount
  useEffect(() => {
    // In real app, fetch team member data by ID from API
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-end gap-4 pt-6">
            ...
            >
              ...
              {isLoading ? "Updating Team Member..." : "Update Team Member"}
            </Button>
          </div>
        </form>
      </div>
